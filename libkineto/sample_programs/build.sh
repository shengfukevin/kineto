...
nvcc -c kineto_playground.cu -o kplay_cu.o -I/usr/local/cuda-12.2/include
...
g++ \
  ...
  /usr/local/cuda-12.2/extras/CUPTI/lib64/libcupti.so \
  /usr/local/cuda-12.2/extras/CUPTI/lib64/libnvperf_host.so \
